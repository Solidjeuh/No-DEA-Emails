...
$lang = array_merge($lang, array(
		...
		'ACP_NO_DEA_EMAILS_WARNING_CRON'	=> 'In dit gedeelte worden de CRON statusgegevens verkregen.<br>- De optie om het tijdsinterval voor uitvoering van de CRON te definiëren is ingeschakeld.<br>Een relatie van de e-maildomeinen van het DEA type wordt getoond waarmee ze gefilterd worden in de e-mailaccounts van de gebruikers van het forum.',
		'ACP_NO_DEA_EMAILS_WARNING_LOCAL'	=> 'In dit gedeelte kunt u lokale domeinen van wegwerp of tijdelijke e-mailaccounts beheren (toevoegen/verwijderen) <a href="https://bit.ly/2LBsbqe" target="_blank">(DEA)</a>.<br><br>Er moet speciale aandacht worden besteed, want als een geldig domein wordt toegevoegd, zullen we voorkomen dat gebruikers zich kunnen registreren.<br><i>Voorbeeld: als we het domein "gmail.com" toevoegen, zullen we alle mensen uitsluiten die willen registreren met een Google account.</i> ',
		'ACP_NO_DEA_EMAILS_WARNING_USERS'	=> 'Dit gedeelte verzamelt informatie over alle forumgebruikers die een wegwerpmail hebben <a href="https://bit.ly/2LBsbqe" target="_blank">(DEA)</a> gekoppeld aan hun account.<br><br>We kunnen de gebruikers die zijn geselecteerd <strong>VOLLEDIG verwijderen</strong>.<br>(Inclusief al hun gepubliceerde berichten)<br><br><strong>AANDACHT:<br>Deze actie is NIET OMKEERBAAR, wees voorzichtig wanneer u deze optie gebruikt als uw forum in productie is.</strong>',
		...
		'ACP_SUBMIT_DELETE'					=> 'Gebruikers volledig verwijderen (inclusief al hun gepubliceerde berichten)',
		'LOG_CONFIG_CONFIGURATION'			=> '<strong>Bijgewerkte configuratie extensie “Geen DEA e-mails”</strong>',
		...
		'L_NO_DEA_EMAILS_CONFIG'			=> 'CRON configuratieopties',
